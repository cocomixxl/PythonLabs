...
# A for loop is better for iterating a specific number of times or through a sequence. A while loop is more suited for cases where the termination of a condition.
...
# Placing print(i) before the conditional ensures that every generated employee ID is displayed, regardless of whether it triggers the additional message about the remaining IDs.

# ## Conclusion
# **What are your key takeaways from this lab?**
# 
# Learned to use loops and conditional logic for automating security tasks and analyzing system data efficiently.    
# 
# 
# 
# 
