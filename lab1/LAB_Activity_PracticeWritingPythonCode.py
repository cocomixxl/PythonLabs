...
# I noticed the In variable is the amount times the code executed the message that got printed out of the code cell
# 
...
Nothing happened because theres no executable code found from what i see at the frontend.
...
# Now that I've done this a few times im rethinking my first answer when I said the In variable is the amount of times the code is executed. This just showed sixteen on the first execution, so the variable must be different. 
...
# It is showing the message out of the code cell but the In is probably not the amount of times I ran the code might be the attempts
# 
...
# The same output as before just a different message.
...
# The in just counts up from the last number and the prints sends the messages in order.

# ## Conclusion
# **What are your key takeaways from this lab?**
# Comments in Python start with a hashtag (#). To display a message on the frontend (console), use the print() function with parentheses, placing the message inside single quotes (') or double quotes (").
