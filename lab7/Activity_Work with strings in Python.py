...
print(type(employee_id))  # Outputs: <class 'int'>

# Reassign `employee_id` to the same value but in the form of a string
employee_id = str(employee_id)

# Display the data type of `employee_id` now
print(type(employee_id))  # Outputs: <class 'str'>
...
# The first time, employee_id is displayed as <class 'int'>.
# After reassignment, it is displayed as <class 'str'>.
...
print(employee_id)  # Outputs: "4186"
...
print(employee_id)  # Outputs: "E4186"
...
print(device_id[0:3])  # Outputs: "r26"
...
print(url.index(".com"))  # Outputs: 18
...
print(url[ind:ind+4])  # Outputs: ".com"


# #### **Question 2**
# **What does this code output and why?**

# The code outputs .com because the slice starts at the index where .com begins and ends 4 characters later (ind:ind+4).
# 
# 
...
print(url[8:ind])  # Outputs: "exampleURL1"
...
# 
# Converting data types, using string slicing and indexing, applying conditional logic, and leveraging methods like .index() are essential tools for efficiently manipulating and extracting information from strings in Python.
# 
#     
# 
# 
