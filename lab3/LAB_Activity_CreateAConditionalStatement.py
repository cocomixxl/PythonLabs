...
# When I change the system variable to "OS 1" or "OS 3" no output is displayed.
...
# When I put the system variable to OS 1 or 3 the output message is update needed and for OS 2 it's no update needed
...
# 
# Practiced working with lists and Boolean values to handle real-world scenarios such as login authentication.
