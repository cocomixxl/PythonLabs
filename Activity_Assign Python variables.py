...
# The type is a string and theres numbers and letters in tha t variable.
...
# The data type of username_list is a list type indicating that it stores multiple items in a single variable as a list.
...
# The updated username_list contains six elements, including the new username lpope.
...
# The data type of max_logins is a int type indicating that it is an integer.
...
# Check if `login_attempts` is less than or equal to `max_logins`
...
# The output is True this means the current number of login attempts is within the allowed limit.
...
# Assign `login_attempts` to a specific value (e.g., 4)
login_attempts = 4
...
# The login_status is a bool type meaning its a boolean value wich represents a true or false.

# ## Conclusion
# 
# **What are your key takeaways from this lab?**

# Python efficiently handles data types, supports updates, and uses Booleans for decisions.

# In[13]:


Python efficiently handles data types, supports updates uses Booleans decisions.
